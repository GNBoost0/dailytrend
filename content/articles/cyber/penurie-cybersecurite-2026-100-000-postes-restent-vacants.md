---
title: "Pénurie cybersécurité 2026 : 100 000 postes restent vacants"
description: "La France affiche 100 000 postes vacants en cybersécurité en 2026. Décryptage d'une crise qui fragilise nos entreprises et les pistes pour y remédier rapidement."
date: "2026-05-19"
topic: "cyber"
...
Les chiffres parlent d'eux-mêmes. Le **Baromètre 2026 des fuites de données personnelles**, publié par le Forum INCYBER à partir des données de la CNIL, recense **8 613 violations de données en un an** — soit une hausse de **+45 %** par rapport à 2025. Comme nous le détaillions dans notre article sur [les fuites de données 2026 et l'industrialisation qui change tout](/cyber/fuites-de-donnees-2026-45-et-lindustrialisation-qui-change-tout), les cybercriminels ont industrialisé leurs méthodes.
...
Les collectivités territoriales sont encore plus touchées, comme nous le racontions dans [notre enquête sur le cauchemar cyber des mairies en 2026](/cyber/cyber-mairies-2026-le-cauchemar-des-collectivites-francaises). Une commune de 15 000 habitants ne peut pas proposer 70 000 € à un expert cyber. Elle ne peut pas non plus rivaliser avec une banque parisienne ou un GAFAM.
...
Les entreprises qui pratiquent le [red teaming en 2026](/cyber/red-teaming-2026-les-entreprises-se-piratent-elles-memes) le savent : elles simulent des attaques pour tester leurs défenses, et constatent souvent que leurs équipes sont débordées avant même que l'exercice ne commence.
...
En attendant que les effectifs montent, certaines entreprises se tournent vers la [cyber-assurance](/cyber/cyber-assurance-2026-un-marche-qui-explose-et-coute-cher) pour couvrir leurs risques. Le marché explose : +35 % de primes émises en 2025 selon France Assureurs. Mais une assurance ne remplace pas un expert. Elle permet de limiter les pertes financières après l'incident, pas de l'éviter.
...
- [Cybersecurite-info.fr — Actualités et veille sur la cybersécurité](https://cybersecurite-info.fr/) — Cybersecurite-info.fr, consulté le 19/05/2026
- [Baromètre des fuites de données personnelles — Edition 2026](https://dcmag.fr/barometre-des-fuites-de-donnees-personnelles-edition-2026/) — DC Mag / Forum INCYBER, 2026
- [La fuite de données à l'ANTS, nouvelle illustration des failles de sécurité des services informatiques de l'État](https://www.lemonde.fr/societe/article/2026/04/22/la-fuite-de-donnees-a-l-agence-nationale-des-titres-securises-nouvelle-illustration-des-failles-de-securite-des-services-informatiques-de-l-etat_6682449_3224.html) — Le Monde, 22/04/2026
- [Fuites de données : les 10 incidents majeurs au 14 mai 2026](https://dcod.ch/2026/05/14/fuites-de-donnees-les-10-incidents-majeurs-au-14-mai-2026/) — Dcod.ch, 14/05/2026
- [Cybersécurité : actualités en direct — Les Echos](https://www.lesechos.fr/tech-medias/hightech/cybersecurite) — Les Echos, consulté le 19/05/2026