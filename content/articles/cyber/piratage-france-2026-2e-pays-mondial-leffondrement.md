...
Le physionomie des attaques a changé. Les pirates ne cherchent plus seulement à extraire des bases de données pour les revendre. Ils aspirent littéralement l'identité numérique des personnes : mots de passe, sessions de navigateur, cookies d'authentification, jetons bancaires. Comme nous l'avions analysé dans notre enquête sur [l'usine infernale des Stealer Logs](/cyber/stealer-logs-2026-lusine-infernale-de-vos-donnees), ces « journaux de vol » s'échangent désormais en gros sur Telegram, à quelques dollars les milliers de lignes.
...
Nous avons documenté ce phénomène dans notre analyse de la [fuite FICOBA](/cyber/fuite-ficoba-lidentite-bancaire-des-francais-sacrifiee-en-2026), où l'identité bancaire de millions de Français a été compromise. Le même schéma se répète avec l'ANTS, dont les failles ont permis la création de faux titres d'identité utilisés pour ouvrir des comptes bancaires frauduleux.
...
Nous avons déjà documenté comment [l'arnaque au deepfake audio](/cyber/deepfake-audio-2026-larnaque-au-pdg-qui-vide-les-comptes) permet d'imiter la voix d'un dirigeant pour soutirer des virements. Mais en 2026, le phénomène a atteint une nouvelle échelle.
...
- [Have I Been Pwned — June 2026 Stealer Logs](https://haveibeenpwned.com) — HIBP, 15 juin 2026
- [FrenchBreaches — Annuaire des violations 2026](https://frenchbreaches.com/) — FrenchBreaches, juillet 2026
- [Fuite de données France 2026 : 250M exposés](https://shattered.io/fr/fuite-donnees-france-2026/) — shattered.io, 2026
- [Cybersécurité : actualités en direct](https://www.lesechos.fr/tech-medias/hightech/cybersecurite) — Les Échos, juillet 2026
- [Actualités Cybersécurité](https://www.it-connect.fr/actualites/actu-securite/) — IT-Connect, juillet 2026
...
- [Cybersecurite-info.fr — Veille cyber](https://cybersecurite-info.fr/) — Cybersecurite-info, juillet 2026