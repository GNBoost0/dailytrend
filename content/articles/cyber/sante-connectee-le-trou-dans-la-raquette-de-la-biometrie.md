---
title: "Santé connectée : le trou dans la raquette de la biométrie"
description: "250 millions de données de santé volées en France : pourquoi la biométrie ne protège pas vos diagnostics. L'enquête alarmante."
date: "2026-08-10"
topic: "cyber"
...
Contrairement à une [carte bancaire](/cyber/dark-web-2026-votre-carte-bancaire-vaut-moins-que-10) que l'on peut bloquer et remplacer en quelques minutes, tes données médicales sont éternelles. Ton groupe sanguin, tes allergies, ton historique de maladies, ça ne change pas. Pour les cybercriminels, c'est une valeur sûre pour le chantage, l'usurpation d'identité sophistiquée ou la vente sur le Dark Web à des assureurs peu scrupuleux.

Le mythe de la biométrie salvatrice doit être déconstruit urgemment.

Pendant qu'on nous persuade d'abandonner nos mots de passe au profit de notre empreinte digitale ou de la reconnaissance faciale pour accéder à nos dossiers patients, les serveurs qui stockent ces données suintent de partout. Le problème n'est plus l'authentification de l'utilisateur — même si le [Social Engineering](/cyber/social-engineering-20-quand-votre-voix-devient-votre-pire-ennemi) reste une menace majeure — mais la sécurité des bases de données centrales.
...
L'autre angle mort, souvent ignoré par les médias grand public, c'est la [Supply Chain Attack](/cyber/supply-chain-attack-2026-le-cout-cache-de-lexternalisation). Les hôpitaux et les cliniques n'ont pas toujours les moyens d'héberger des infrastructures ultra-sécurisées. Ils externalisent.
...
La première étape est de sortir du déni. Il faut accepter que nos données sont probablement déjà compromises quelque part. L'ère de l'innocence numérique est révolue. Pour les entreprises et les institutions de santé, le "Cloud Act" et les législations internationales compliquent encore la tâche, comme nous l'expliquions dans notre analyse sur le [Cloud Act 2026](/cyber/cloud-act-2026-vos-donnees-ne-sont-plus-chez-vous). Vos données ne sont plus "chez vous", elles voyagent, et elles sont vulnérables à chaque frontière numérique traversée.

Les stratégies de défense doivent évoluer.

1.  **Zéro confiance :** Plus personne, aucun appareil, ne devrait avoir accès au réseau sans vérification continue, même à l'intérieur de l'hôpital.
2.  **Segmentation radicale :** Les données de santé ne doivent jamais être mélangées avec les données administratives ou commerciales sur les mêmes serveurs.
3.  **Chiffrement homomorphe :** C'est technique, mais essentiel. Permettre de traiter des données chiffrées sans jamais les déchiffrer pourrait sauver la vie de la privacy santé.
4.  **Audit externe obligatoire :** Les sous-traitants de la santé doivent subir des audits de sécurité pénibles, réguliers et imprévisibles.

Le monde de la [fintech et de la crypto](/crypto/bitcoin-2026-lindicateur-fear-greed-sonne-lalarme) a compris il y a des années que la confiance ne se décrète pas, elle se prouve par la sécurité. La santé tarde à comprendre cette leçon. Pourtant, l'enjeu est bien plus élevé que quelques bitcoins perdus sur une wallet mal sécurisée.
...
- [Cybersécurité : actualités en direct - Les Echos](https://www.lesechos.fr/tech-medias/hightech/cybersecurite) — Les Échos, 2026