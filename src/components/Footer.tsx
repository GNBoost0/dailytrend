          ...
          <div className="flex flex-col md:flex-row items-center md:justify-center gap-8 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 md:gap-10 w-full sm:w-auto">
              ...
              <div>
                ...
                <Link href="/politique-de-confidentialite" className="block text-xs py-1 transition-colors hover:opacity-80" style={{color:'var(--text-secondary)'}}>Politique de confidentialité</Link>
              </div>
            </div>
          </div>
